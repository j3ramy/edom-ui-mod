...
public class CreditCardPrinterContainer extends Container {

    public CreditCardPrinterTile tileEntity;
    private final PlayerEntity playerEntity;
    private final IItemHandler playerInventory;

    public CreditCardPrinterContainer(int windowId, PlayerInventory inv, CreditCardPrinterTile tile){
        super(ModContainers.CREDIT_CARD_PRINTER_CONTAINER.get(), windowId);
        ...
        if(tileEntity != null){
            tileEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(h ->{
                ...
                addSlot(new SlotItemHandler(h, 0, 25, 19));
                addSlot(new SlotItemHandler(h, 1, 25, 65));
            });
        }
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        return isWithinUsableDistance(IWorldPosCallable.of(Objects.requireNonNull(tileEntity.getWorld()), tileEntity.getPos()), playerIn, ModBlocks.CREDIT_CART_PRINTER.get());
    }
