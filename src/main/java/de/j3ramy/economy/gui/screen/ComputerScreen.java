...
//                }));
    ...
    public void initTableOverviewScreen() {
        ...
        //List of tables
        this.tableOverviewScreen.addList(this.tableList = new ScrollableList(this.xLeft + 2, this.yTop + 34, 75, yBottom - 2 - (this.yTop + 34), 13, Color.DARK_GRAY_HEX, Color.WHITE_HEX, Color.RED_HEX));

        //List of Entries in Table
        this.tableOverviewScreen.addTable(table = new ScrollableTable(this.xLeft + 82, this.yTop + 34, this.xRight - 2 - (this.xLeft + 82), yBottom - 2 - (this.yTop + 34), 10, true, Color.DARK_GRAY_HEX, Color.WHITE_HEX, Color.BORDER_OLIVE_HEX, Color.ORANGE_HEX));
