...
public class ModItems {
    ...
    public static final RegistryObject<Item> ETHERNET_CABLE = ITEMS.register("ethernet_cable", () -> new EthernetCable(new Item.Properties().group(ModItemGroup.ECONOMY_GROUP).maxStackSize(1)));
