...
public class AtmContainer extends Container {
    ...
    public AtmContainer(int windowId, World world, BlockPos pos, PlayerInventory playerInventory, PlayerEntity player, AtmTile tile){
        super(ModContainers.ATM_STORAGE_CONTAINER.get(), windowId);
        ...
        if(tileEntity != null){
            tileEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(h ->{
                ...
                for(int i = 0; i < 8; i++ ){
                    addSlot(new SlotItemHandler(h, i, xPos, yPos));
                    xPos += 18;
                }
            });
        }

        layoutPlayerInventorySlots(8, 88); //Position of player inventory
    }
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        ...
        return isWithinUsableDistance(IWorldPosCallable.of(tileEntity.getWorld(), tileEntity.getPos()), playerIn, ModBlocks.ATM.get());
    }
