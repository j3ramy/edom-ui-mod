...
public class FirstAidCabinetContainer extends Container {

    public TileEntity tileEntity;
    private final PlayerEntity playerEntity;
    private final IItemHandler playerInventory;

    public FirstAidCabinetContainer(int windowId, World world, BlockPos pos, PlayerInventory playerInventory, PlayerEntity player, FirstAidCabinetTile tile){
        super(ModContainers.FIRST_AID_CABINET_CONTAINER.get(), windowId);
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        ...
        return isWithinUsableDistance(IWorldPosCallable.of(tileEntity.getWorld(), tileEntity.getPos()), playerIn, ModBlocks.FIRST_AID_CABINET.get());
    }
