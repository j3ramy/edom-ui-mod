...
public class MailboxContainer extends Container {
    ...
    public MailboxContainer(int windowId, World world, BlockPos pos, PlayerInventory playerInventory, PlayerEntity player, MailboxTile tile){
        ...
        if(tileEntity != null){
            tileEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(h ->{
                ...
                for(int i = 0; i < 3; i++){
                    for(int j = 0; j < 3; j++){
                        addSlot(new SlotItemHandler(h, counter, xPos, yPos));
                        xPos += 18;
                        counter++;
                    }
        ...
        layoutPlayerInventorySlots(8, 84); //Position of player inventory
    }
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        ...
        return isWithinUsableDistance(IWorldPosCallable.of(tileEntity.getWorld(), tileEntity.getPos()), playerIn, ModBlocks.MAILBOX.get());
    }
